...
namespace SyncCyberPlan_lib
{
    public class Articolo: Item
    {
        ...
        public override void Init(object[] row)
        {
            ...
            ITMDES1_0           = getDBV<string>(row[1], "ITMDES1_0");
            STU_0               = getDBV<string>(row[2], "STU_0");
            PUU_0               = getDBV<string>(row[3], "PUU_0");
            SAU_0               = getDBV<string>(row[4], "SAU_0");
            TCLCOD_0            = getDBV<string>(row[5], "TCLCOD_0");
            YLIVTRAS_0          = getDBV<string>(row[6], "YLIVTRAS_0");
            YFAMCOM_0           = getDBV<string>(row[7], "YFAMCOM_0");
            //YPRDAPP_0         = getDBV_char(row[8], "");  campo che non eiste più
            REOCOD_0            = getDBV<byte>(row[9], "REOCOD_0");             //tipo proposta
            PRPLTI_0            = getDBV<decimal>(row[10], "PRPLTI_0");
            SHR_0               = getDBV<decimal>(row[11], "SHR_0");            //% scarto
            DEFLOCTYP[0]        = getDBV<string>(row[12], "DEFLOCTYP[0]");
            DEFLOCTYP[1]        = getDBV<string>(row[13], "DEFLOCTYP[1]");
            DEFLOCTYP[2]        = getDBV<string>(row[14], "DEFLOCTYP[2]");
            DEFLOCTYP[3]        = getDBV<string>(row[15], "DEFLOCTYP[3]");
            DEFLOCTYP[4]        = getDBV<string>(row[16], "DEFLOCTYP[4]");
            DEFLOCTYP[5]        = getDBV<string>(row[17], "DEFLOCTYP[5]");
            DEFLOCTYP[6]        = getDBV<string>(row[18], "DEFLOCTYP[6]");
            DEFLOCTYP[7]        = getDBV<string>(row[19], "DEFLOCTYP[7]");
            DEFLOCTYP[8]        = getDBV<string>(row[20], "DEFLOCTYP[8]");
            DEFLOCTYP[9]        = getDBV<string>(row[21], "DEFLOCTYP[9]");
            DEFLOCTYP[10]       = getDBV<string>(row[22], "DEFLOCTYP[10]");
            DEFLOCTYP[11]       = getDBV<string>(row[23], "DEFLOCTYP[11]");
            DEFLOCTYP[12]       = getDBV<string>(row[24], "DEFLOCTYP[12]");
            DEFLOCTYP[13]       = getDBV<string>(row[25], "DEFLOCTYP[13]");
            DEFLOCTYP[14]       = getDBV<string>(row[26], "DEFLOCTYP[14]");
            DEFLOC[0]           = getDBV<string>(row[27], "DEFLOC[0]");
            DEFLOC[1]           = getDBV<string>(row[28], "DEFLOC[1]");
            DEFLOC[2]           = getDBV<string>(row[29], "DEFLOC[2]");
            DEFLOC[3]           = getDBV<string>(row[30], "DEFLOC[3]");
            DEFLOC[4]           = getDBV<string>(row[31], "DEFLOC[4]");
            DEFLOC[5]           = getDBV<string>(row[32], "DEFLOC[5]");
            DEFLOC[6]           = getDBV<string>(row[33], "DEFLOC[6]");
            DEFLOC[7]           = getDBV<string>(row[34], "DEFLOC[7]");
            DEFLOC[8]           = getDBV<string>(row[35], "DEFLOC[8]");
            DEFLOC[9]           = getDBV<string>(row[36], "DEFLOC[9]");
            DEFLOC[10]          = getDBV<string>(row[37], "DEFLOC[10]");
            DEFLOC[11]          = getDBV<string>(row[38], "DEFLOC[11]");
            DEFLOC[12]          = getDBV<string>(row[39], "DEFLOC[12]");
            DEFLOC[13]          = getDBV<string>(row[40], "DEFLOC[13]");
            DEFLOC[14]          = getDBV<string>(row[41], "DEFLOC[14]");
            YQTAMIN_0           = getDBV<decimal>(row[42], "YQTAMIN_0");
            YQTAMAX_0           = getDBV<decimal>(row[43], "YQTAMAX_0");
            YQTAMUL_0           = getDBV<decimal>(row[44], "YQTAMUL_0");
            REOTSD_0            = getDBV<decimal>(row[45], "REOTSD_0");
            SAFSTO_0            = getDBV<decimal>(row[46], "SAFSTO_0");
            MAXSTO_0            = getDBV<decimal>(row[47], "MAXSTO_0");
            REOMINQTY_0         = getDBV<decimal>(row[48], "REOMINQTY_0"); //lotto economico
            MFGLOTQTY_0         = getDBV<decimal>(row[49], "MFGLOTQTY_0");  //lotto tecnico
            MFGLTI_0            = getDBV<decimal>(row[50], "MFGLTI_0");  // Lead time di produzione
            QUALTI_0            = getDBV<decimal>(row[51], "QUALTI_0");  // Lead time controllo qualità
            OFS_0               = getDBV<decimal>(row[52], "OFS_0"); // Lead time Acquisto
            LOCNUM[0]           = getDBV<byte>(row[53], "LOCNUM[0]");
            LOCNUM[1]           = getDBV<byte>(row[54], "LOCNUM[1]");
            LOCNUM[2]           = getDBV<byte>(row[55], "LOCNUM[2]");
            LOCNUM[3]           = getDBV<byte>(row[56], "LOCNUM[3]");
            LOCNUM[4]           = getDBV<byte>(row[57], "LOCNUM[4]");
            LOCNUM[5]           = getDBV<byte>(row[58], "LOCNUM[5]");
            LOCNUM[6]           = getDBV<byte>(row[59], "LOCNUM[6]");
            LOCNUM[7]           = getDBV<byte>(row[60], "LOCNUM[7]");
            LOCNUM[8]           = getDBV<byte>(row[61], "LOCNUM[8]");
            LOCNUM[9]           = getDBV<byte>(row[62], "LOCNUM[9]");
            LOCNUM[10]          = getDBV<byte>(row[63], "LOCNUM[10]");
            LOCNUM[11]          = getDBV<byte>(row[64], "LOCNUM[11]");
            LOCNUM[12]          = getDBV<byte>(row[65], "LOCNUM[12]");
            LOCNUM[13]          = getDBV<byte>(row[66], "LOCNUM[13]");
            LOCNUM[14]          = getDBV<byte>(row[67], "LOCNUM[14]");
            YNUMVIE_0           = getDBV<short>(row[68], "YNUMVIE_0");
            YALTEZZA_0          = getDBV<decimal>(row[69], "YALTEZZA_0");
            YMRPTAG1_0          = getDBV<string>(row[70], "YMRPTAG1_0");
                               
            YCORPOLUN_0         = getDBV<decimal>(row[71], "YCORPOLUN_0");        //lunghezza x WP (?)
            YCORPOPRO_0         = getDBV<decimal>(row[72], "YCORPOPRO_0");        //profodità...
            YMAT_0              = getDBV<string>(row[73], "YMAT_0");         //per capire se è sth il WG
            YTAGOEM_0           = getDBV<string>(row[74], "YTAGOEM_0");         //MArchio
            WEU_0               = getDBV<string>(row[75], "WEU_0");         //deve essere GR per WP
            ITMWEI_0            = getDBV<decimal>(row[76], "ITMWEI_0");        //peso WP
            YCOLORE_0           = getDBV<string>(row[77], "YCOLORE_0");
            //BPSNUM_0          = getDBV<string>(row[78], "");
            BPSNUM_0            = "";
            YPESMAT_0           = getDBV<decimal>(row[79], "YPESMAT_0");        //peso materozza/impronta
            YPASSOVIE_0         = getDBV<string>(row[80], "YPASSOVIE_0");
            STDFLG_0            = getDBV<byte>(row[81], "STDFLG_0");            //gestione a stock/commessa
            YCONFQTA_0          = getDBV<int>(row[82], "YCONFQTA_0");
            YQTADECIMI_0        = getDBV<int>(row[83], "YQTADECIMI_0");
            YWCR_0              = getDBV<string>(row[84], "YWCR_0");   //reparto (CdC)
            YQTAPREANT_0        = getDBV<decimal>(row[85], "YQTAPREANT_0");
            FAMPEX              = getDBV_char(row[86], "FAMPEX");
            YSTAMPCOLORE_0      = getDBV<string>(row[87], "YSTAMPCOLORE_0");
            YPIEFLG_0           = getDBV<byte>(row[88], "YPIEFLG_0");
            PHAFLG_0            = getDBV<byte>(row[89], "PHAFLG_0");
